/**
 * A DoubleNode provides a node for a linked list with double data
 * in each node.
 *
 * @note Lists of nodes can be made of any length, limited only by the amount of
 *       free memory in the heap.  Beyond Integer.MAX_VALUE
 *       (2,147,483,647), the answer from listLength is incorrect
 *       because of arithmetic overflow.
 *
 * @author   Michael Main
 * @revision Scott Bennett
 */
public class DoubleNode {
     ...
     * @param initialLink a reference to the node after this new node &ndash;
     *        this reference may be null to indicate that there
     *        is no node after this new node.
     *
     * @postcondition This node contains the specified data and link to the
     *                next node.
     */
    ...
    /**
     * Initializes a node with default values for data and link, which are
     * 0.0 and null respectively. 
     * 
     * @postcondition This node has value 0.0 and nothing after it.
     */
    public DoubleNode() {
        data = 0.0;
        link = null;
    ...
    /**
     * Initializes a node with a specified initial data and a default value
     * for link, which is null.
     * 
     * @postcondition This node contains the specified data and nothing
     *                after it.
     */
     ...
     *
     * @return a reference to the node after this node (or the null reference
     ...
     *                in the linked list, or the null reference if there is no
     *                node after this node.
     *
     * @postcondition The link to the node after this node has been set to
     *                newLink.  Any other node that used to be in this link is
     ...
     *                list.  If there were further nodes after that one, they
     *                are still present on the list.
     *
     * @throws NullPointerException Indicates that this was the tail node of
     *                              the list, so there is nothing after it to
     *                              remove.
     */
     ...
     * head of the copy.
     *
     * @param source the head of a linked list that will be copied (that may be
     *               an empty list in where source is null)
     *
     * @return the head reference for the copy.
     *
     * @postcondition The method has made a copy of the linked list starting
     *                at source.
     */
     ...
     *
     * @param head the head reference for a linked list (that may be an empty
     ...
     * copy.
     *
     * @param start a reference to a DoubleNode that represents
     *              the starting point for the copy.
     *
     * @param end   a reference to a DoubleNode that represents
     *              the ending point for the copy.
     *
     * @precondition start and end are non-null
     *               references to nodes on the same linked list, with the
     *               start node at or before the end node.
     *
     ...
     *
     * @throws NullPointerException Indicates that start or end is null.
     */
     ...
     *         node is position 2, and so on.) If there is no such position
     *         (because the list is too short), then the null reference is
     *         returned.
     *
     * @throws IllegalArgumentException Indicates that position is not
     *                                     positive.
     */
    ...
    public static DoubleNode listSearch(DoubleNode head, double target) {
        ...
        for (DoubleNode cursor = head; targetNode == null && cursor != null;
                                                        cursor = cursor.link) {
